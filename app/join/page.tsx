...
export const metadata: Metadata = {
  ...
  description:
    "Join SODGEM — Spring of Divine Grace Evangelical Mission. Find Sunday service times, weekly Bible studies, and locations across Sagamu, Ogun State, Nigeria.",
...
const eventJsonLd = {
  "@context": "https://schema.org",
  "@type": "Event",
  name: "Sunday Celebration & Weekly Gatherings",
  description:
    "Sunday services, Monday covenant hour of prayer, Tuesday Bible studies, and monthly communion and cross-over night at SODGEM.",
  startDate: "T08:00",
  location: {
    "@type": "Place",
    name: siteConfig.organizationName,
...
const branches = [
  {
    name: "Headquarters",
    address:
      "No. 33B Simolade Street, Off Oba-Erinwole Expressway, GRA, Sagamu, Ogun State",
  },
  {
    name: "Ewuga Branch",
      ...
      <header className="bg-blue-600 py-24 px-4 text-white text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-blue-100 font-medium">
            Come and drink from a spring that never stops running.
          </p>
        </div>
      </header>
          ...
          <div className="bg-slate-50 rounded-3xl p-8 border border-slate-100">
            ...
            <div className="mt-8 p-6 bg-blue-600 rounded-2xl text-white flex items-center gap-4">
              ...
              <p className="font-bold">
                Cross Over Night: Last day of every month at 10:00 PM
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-6">
            {branches.map((branch, i) => (
              <div
                key={i}
                className="p-8 bg-white border border-slate-200 rounded-3xl hover:border-blue-600 transition-colors group"
              >
                <h4 className="text-xl font-black mb-3 text-slate-900 group-hover:text-blue-600 transition-colors uppercase tracking-wider">
                  {branch.name}
                </h4>
          ...
          <div className="mt-12 p-10 bg-slate-950 rounded-[3rem] text-white">
            ...
            <p className="text-slate-400 mb-8 leading-relaxed">
              Whether you&apos;re a professional looking to use your skills for
