    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-10">
          ...
          {/* <Link
            href="/join"
            className="bg-blue-600 text-white px-7 py-2.5 rounded-full font-bold text-sm hover:bg-blue-700 transition-all shadow-xl shadow-blue-500/20 active:scale-95"
          >
            Give Now
          </Link> */}
        </div>
        ...
        <div className="p-6 flex flex-col h-full">
          ...
          <div className="mt-auto pt-10">
            {/* <Link
              href="/join"
              onClick={() => setMobileMenuOpen(false)}
              className="w-full bg-blue-600 text-white py-4 rounded-2xl font-bold text-lg shadow-xl shadow-blue-200 flex items-center justify-center"
            >
              Give Now
            </Link> */}
          </div>
