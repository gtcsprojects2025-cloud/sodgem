...
export const metadata: Metadata = {
  title: {
    absolute: `${siteConfig.name} — ${siteConfig.organizationName}`,
  },
  description:
    "SODGEM — Spring of Divine Grace Evangelical Mission. Experience a community where grace restores hearts, empowers minds, and awakens destiny.",
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Worship gathering at SODGEM"
            fill
            priority
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white mb-8 leading-[0.95] tracking-tighter">
              JESUS — The Spring That{" "}
              <span className="text-blue-500 italic font-serif">Never</span>{" "}
              Stops.
            </h1>

            <p className="text-xl text-slate-300 mb-10 max-w-xl leading-relaxed font-medium">
              Experience a community where grace isn&apos;t a theory, but a
              Person who restores hearts, empowers minds, and awakens destiny.
            </p>
        ...
        >
          <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-6 rounded-3xl max-w-xs text-white">
            <div className="flex -space-x-3 mb-4">
              {["JO", "TA", "MK", "RE"].map((initials) => (
                <div
                  key={initials}
                  className="w-10 h-10 rounded-full border-2 border-slate-900 bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-[10px] font-bold text-white"
                >
                  {initials}
                </div>
              ))}
            ...
            <p className="text-sm font-bold leading-snug">
              Join hundreds finding their purpose through Grace every week.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
          <div className="relative">
            <div className="aspect-[4/5] rounded-[3rem] overflow-hidden shadow-2xl relative z-10">
              <Image
                src="/restoration2.jpg"
                alt="Restoration — spiritually alive and emotionally whole people at SODGEM"
                fill
            ...
            <div className="absolute -bottom-10 -right-10 w-64 bg-blue-600 p-8 rounded-[2rem] text-white shadow-2xl z-20 hidden md:block">
              <h3 className="text-4xl font-black mb-2 italic font-serif">
                Whole
              </h3>
              <p className="font-bold opacity-90 leading-tight">
                Spiritually alive, financially free, and emotionally healed.
              </p>
            </div>
          ...
          <div>
            <h4 className="text-blue-600 font-black uppercase tracking-[0.3em] text-sm mb-4">
              The SODGEM Way
            </h4>
            <h2 className="text-4xl md:text-6xl font-black text-slate-900 mb-8 tracking-tighter leading-tight">
              We&apos;re not building a religion, we&apos;re awakening{" "}
              <span className="text-blue-600">restoration</span>.
            </h2>
            <p className="text-xl text-slate-600 mb-10 leading-relaxed font-medium">
              At SODGEM, we believe Grace is a Person—Jesus. Our mission is to
              raise ambassadors who are complete in every sphere: spirits,
              minds, and marketplace leaders.
            </p>
            ...
            <div className="grid gap-6">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center space-x-6 p-4 rounded-2xl hover:bg-slate-50 transition-colors group cursor-default"
                >
                  <div
...
{/* Schedule - Bento Grid Style */}
      <section
        id="services"
        className="py-32 px-4 bg-slate-950 text-white rounded-[4rem] mx-4 my-8"
      >
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div className="max-w-2xl">
              <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-4 italic font-serif">
                Weekly Gatherings
              </h2>
              <p className="text-slate-400 text-xl font-medium">
                Step into a space of power, prayer, and deep biblical wisdom.
              </p>
            </div>
            <Link
              href="/join"
              className="group flex items-center space-x-3 text-blue-400 font-bold uppercase tracking-widest text-sm hover:text-white transition-colors"
            >
          ...
          <div className="grid md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-8 bg-blue-600 p-10 rounded-[3rem] relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-blue-100 text-lg mb-8 max-w-md">
                  Our main worship experience. Expect dynamic praise and
                  life-transforming teaching from the Word.
                </p>
                <div className="flex flex-wrap gap-4">
                  <span className="bg-slate-900 px-6 py-2 rounded-full font-bold">
                    8:00 AM
                  </span>
                  <span className="bg-slate-900/50 px-6 py-2 rounded-full font-bold">
                    10:30 AM
                  </span>
                </div>
              </div>
            ...
            <div className="md:col-span-4 bg-slate-900 p-10 rounded-[3rem] border border-slate-800 hover:border-slate-700 transition-all">
              ...
              <p className="text-slate-400 mb-6">
                Deep theological dives every Tuesday.
              </p>
            ...
            <div className="md:col-span-8 bg-gradient-to-br from-indigo-900 to-blue-900 p-10 rounded-[3rem] flex flex-col justify-center items-center text-center">
              ...
              <p className="text-blue-200 mb-8 max-w-lg">
                We have a special welcome team ready to make you feel right at
                home. No pressure, just grace.
              </p>
              <Link
                href="/join"
                className="bg-white text-blue-900 px-10 py-4 rounded-2xl font-black hover:scale-105 transition-transform"
              >
                Plan Your Visit
              </Link>
            </div>
